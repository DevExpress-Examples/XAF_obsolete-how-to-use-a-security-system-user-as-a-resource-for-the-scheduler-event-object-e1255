...
namespace WinWebSolution.Module {
    ...
    public class Employee : Person, IUserWithRoles, IAuthenticationActiveDirectoryUser, IAuthenticationStandardUser, IResource {
        ...
        [RuleRequiredField("RuleRequiredField for IUserWithRoles.Roles", DefaultContexts.Save)]
        ...
        [Association("Activity-Employees", typeof(Activity), UseAssociationNameAsIntermediateTableName = true)]
        public XPCollection Activities {
            get { return GetCollection("Activities"); }
        }
        [Persistent]
