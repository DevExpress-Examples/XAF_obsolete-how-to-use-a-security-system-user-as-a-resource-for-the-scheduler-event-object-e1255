...
Namespace WinWebSolution.Module
	...
	Public Class Employee
		...
		End Sub
		<Association("User-Role", UseAssociationNameAsIntermediateTableName:=True), RuleRequiredField("RuleRequiredField for IUserWithRoles.Roles", DefaultContexts.Save, TargetCriteria:="IsActive=True", CustomMessageTemplate:="You cannot save an Active employee without Groups")> _
