...
namespace WinWebSolution.Module {
    [DefaultClassOptions]
    public class Activity : BasePersistentObject, IEvent, ISupportRecurrences {
        ...
        public bool IsIntervalValid { get { return AllDay || StartOn <= EndOn; } }
        ...
        public IEvent RecurrencePattern {
            ...
            set { SetPropertyValue("RecurrencePattern", ref _RecurrencePattern, (Activity)value); }
        }
        #endregion
    }
}