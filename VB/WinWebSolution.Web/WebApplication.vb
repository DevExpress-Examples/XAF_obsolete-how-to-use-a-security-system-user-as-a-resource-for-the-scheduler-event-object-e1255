...
Namespace WinWebSolution.Web
    Partial Public Class WinWebSolutionAspNetApplication
        ...
        Private Sub WinWebSolutionAspNetApplication_DatabaseVersionMismatch(sender As Object, e As DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
            e.Updater.Update()
            e.Handled = True
        End Sub
    End Class
